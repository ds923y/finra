...
google.devrel.samples.hello.print = function(greeting) {
  ...
  document.getElementById('outputLog').innerHTML = greeting.message//.appendChild(element);
};
 ...
 */
google.devrel.samples.hello.getGreeting = function(itemsPerPage, phonenumber, id) {
  gapi.client.helloworld.greetings.getGreeting({'itemsPerPage':itemsPerPage,'num':phonenumber, 'id': id}).execute(
      function(resp) {
        if (!resp.code) {
 ...
 */
/*google.devrel.samples.hello.getPage = function(
    greeting, times) {
    alert("called");
  gapi.client.helloworld.greetings.page({
      'phonenum': greeting,
      'pagenum': times
...
google.devrel.samples.hello.enableButtons = function() {
  document.getElementById('getGreeting').onclick = function() {
    google.devrel.samples.hello.getGreeting(document.getElementById('count').value, document.getElementById('greeting').value, document.getElementById('id').value);
  }
  ...
  //}
   ...
   /*document.getElementById('greeting').onchange = function() {
        var phoneUtil = require('google-libphonenumber').PhoneNumberUtil.getInstance();
        var phoneNumber = phoneUtil.parse(document.getElementById('greeting').value, 'US');
        alert(document.getElementById('greeting').value);
        if(phoneUtil.isValidNumber(phoneNumber)){
            alert("valid");
            document.getElementById('multiplyGreetings').disabled = false;
        }else{
            alert("invalid");
            document.getElementById('multiplyGreetings').disabled = true;
        }
   }*/
   ...
   //alert("page");
   //   google.devrel.samples.hello.getPage(
